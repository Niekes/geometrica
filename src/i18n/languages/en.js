export default {
    ...
    home: {
        ...
        applyColorSchemeToEachRect: 'Apply color scheme to each rectangle',
        applyColorSchemeToEachCircle: 'Apply color scheme to each circle',
        applyColorSchemeToEachPolygon: 'Apply color scheme to each polygon',

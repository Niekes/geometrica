<template>
    <div class="cookies">
        ...
        <h1>Cookie Policy for Geometrica</h1>

        <p>This is the Cookie Policy for Geometrica, accessible from https://geometrica.niekes.com/</p>
        ...
        <ul>
            <li>Email: geometrica [at] niekes.com</li>
        </ul>
...
export default {
    ...
    methods: {
        optOut() {
            this.$gtag.optOut();
            window.localStorage.setItem('gtag-cookie-accepted', false);
        },
    },
};
</script>
